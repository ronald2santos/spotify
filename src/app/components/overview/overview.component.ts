...
export class OverviewComponent implements OnInit {
    ...
    getArtistData(artistID: string) {
        this.spotify.getArtistsTopTracks(artistID).subscribe((topTracks) => {
            console.log(topTracks);
            this.topTracks = topTracks.tracks;
        });
        this.spotify.getRelatedArtists(artistID).subscribe((relatedArtists) => {
    ...
    checkFollowing(artistID: string) {
        ...
        this.spotify.checkIfUserFollowsArtists([artistID]).subscribe((following) => {
    ...
    follow() {
        this.spotify.followArtist(this.selectedArtist.id).subscribe((followStatus) => {
    ...
    unfollow() {
        this.spotify.unfollowArtist(this.selectedArtist.id).subscribe((followStatus) => {
            console.log(followStatus);
            this.checkFollowing(this.selectedArtist.id);
        });
    }
